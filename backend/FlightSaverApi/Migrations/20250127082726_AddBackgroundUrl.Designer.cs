...
namespace FlightSaverApi.Migrations
{
    ...
    [Migration("20250127082726_AddBackgroundUrl")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlightSaverApi.Models.CommentLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlightSaverApi.Models.ImageRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlightSaverApi.Models.PostLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FlightSaverApi.Models.CommentLike", b =>
                {
                    b.HasOne("FlightSaverApi.Models.Comment", "Comment")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("FlightSaverApi.Models.PostLike", b =>
                {
                    b.HasOne("FlightSaverApi.Models.SocialPost", "Post")
                        .WithMany("Likes")
            ...
            modelBuilder.Entity("UserFriends", b =>
                {
                    b.HasOne("FlightSaverApi.Models.User", null)
                        .WithMany()
